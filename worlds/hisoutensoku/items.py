...
marisa_skill_table = {
    ...
    itemnames.marisa_22a1: SokuItemData(0xFF0210, ItemClassification.progression),
    itemnames.marisa_22a2: SokuItemData(0xFF0211, ItemClassification.progression),

}

marisa_spell_table = {    
    itemnames.marisa_1sc_ms: SokuItemData(0xFF0212, ItemClassification.progression),
    itemnames.marisa_2sc_sr: SokuItemData(0xFF0213, ItemClassification.progression),
    itemnames.marisa_2sc_ls: SokuItemData(0xFF0214, ItemClassification.progression),
    itemnames.marisa_2sc_os: SokuItemData(0xFF0215, ItemClassification.progression),
    itemnames.marisa_3sc_ms: SokuItemData(0xFF0216, ItemClassification.progression),
    itemnames.marisa_3sc_ev: SokuItemData(0xFF0217, ItemClassification.progression),
    itemnames.marisa_3sc_gb: SokuItemData(0xFF0218, ItemClassification.progression),
    itemnames.marisa_3sc_er: SokuItemData(0xFF0219, ItemClassification.progression),
    itemnames.marisa_4sc_ndl: SokuItemData(0xFF0220, ItemClassification.progression),
    itemnames.marisa_4sc_deb: SokuItemData(0xFF0221, ItemClassification.progression),
    itemnames.marisa_5sc_fs: SokuItemData(0xFF0222, ItemClassification.progression),
    itemnames.marisa_5sc_dm: SokuItemData(0xFF0223, ItemClassification.progression),
    itemnames.marisa_5sc_bs: SokuItemData(0xFF0224, ItemClassification.progression),
    itemnames.marisa_5sc_sfms: SokuItemData(0xFF0225, ItemClassification.progression),
}
...
sakuya_skill_table = {
    ...
    itemnames.sakuya_22a1: SokuItemData(0xFF0310, ItemClassification.progression),
    itemnames.sakuya_22a2: SokuItemData(0xFF0311, ItemClassification.progression),

}

sakuya_spell_table = {
    itemnames.sakuya_2sc_kd: SokuItemData(0xFF0312, ItemClassification.progression),
    itemnames.sakuya_2sc_sb: SokuItemData(0xFF0313, ItemClassification.progression),
    itemnames.sakuya_2sc_em: SokuItemData(0xFF0314, ItemClassification.progression),
    itemnames.sakuya_3sc_ps: SokuItemData(0xFF0315, ItemClassification.progression),
    itemnames.sakuya_3sc_irs: SokuItemData(0xFF0316, ItemClassification.progression),
    itemnames.sakuya_3sc_lr: SokuItemData(0xFF0317, ItemClassification.progression),
    itemnames.sakuya_3sc_ivt: SokuItemData(0xFF0318, ItemClassification.progression),
    itemnames.sakuya_3sc_ld: SokuItemData(0xFF0319, ItemClassification.progression),
    itemnames.sakuya_4sc_pk: SokuItemData(0xFF0320, ItemClassification.progression),
    itemnames.sakuya_4sc_ss: SokuItemData(0xFF0321, ItemClassification.progression),
    itemnames.sakuya_4sc_sss: SokuItemData(0xFF0322, ItemClassification.progression),
    itemnames.sakuya_4sc_cr: SokuItemData(0xFF0323, ItemClassification.progression),
    itemnames.sakuya_5sc_sw: SokuItemData(0xFF0324, ItemClassification.progression),
...
alice_skill_table = {
    ...
    itemnames.alice_22a1: SokuItemData(0xFF0410, ItemClassification.progression),
    itemnames.alice_22a2: SokuItemData(0xFF0411, ItemClassification.progression),

}

alice_spell_table = {
    itemnames.alice_1sc_as: SokuItemData(0xFF0412, ItemClassification.progression),
    itemnames.alice_2sc_ll: SokuItemData(0xFF0413, ItemClassification.progression),
    itemnames.alice_2sc_shd: SokuItemData(0xFF0414, ItemClassification.progression),
    itemnames.alice_2sc_sd: SokuItemData(0xFF0415, ItemClassification.progression),
    itemnames.alice_2sc_tw: SokuItemData(0xFF0416, ItemClassification.progression),
    itemnames.alice_3sc_ri: SokuItemData(0xFF0417, ItemClassification.progression),
    itemnames.alice_3sc_fp: SokuItemData(0xFF0418, ItemClassification.progression),
    itemnames.alice_4sc_dow: SokuItemData(0xFF0419, ItemClassification.progression),
    itemnames.alice_4sc_hd: SokuItemData(0xFF0420, ItemClassification.progression),
    itemnames.alice_4sc_hld: SokuItemData(0xFF0421, ItemClassification.progression),
    itemnames.alice_4sc_cp: SokuItemData(0xFF0422, ItemClassification.progression),
    itemnames.alice_5sc_lp: SokuItemData(0xFF0423, ItemClassification.progression),
...
patchouli_skill_table = {
    ...
    itemnames.patchouli_421a1: SokuItemData(0xFF0510, ItemClassification.progression),
    itemnames.patchouli_421a2: SokuItemData(0xFF0511, ItemClassification.progression),
    itemnames.patchouli_22d: SokuItemData(0xFF0512, ItemClassification.progression),
    itemnames.patchouli_22a1: SokuItemData(0xFF0513, ItemClassification.progression),
    itemnames.patchouli_22a2: SokuItemData(0xFF0514, ItemClassification.progression),

}

patchouli_spell_table = {
    itemnames.patchouli_2sc_nd: SokuItemData(0xFF0515, ItemClassification.progression),
    itemnames.patchouli_2sc_eh: SokuItemData(0xFF0516, ItemClassification.progression),
    itemnames.patchouli_3sc_sep: SokuItemData(0xFF0517, ItemClassification.progression),
    itemnames.patchouli_3sc_jp: SokuItemData(0xFF0518, ItemClassification.progression),
    itemnames.patchouli_3sc_ss: SokuItemData(0xFF0519, ItemClassification.progression),
    itemnames.patchouli_3sc_ps: SokuItemData(0xFF0520, ItemClassification.progression),
    itemnames.patchouli_3sc_pp: SokuItemData(0xFF0521, ItemClassification.progression),
    itemnames.patchouli_4sc_ss: SokuItemData(0xFF0522, ItemClassification.progression),
    itemnames.patchouli_4sc_em: SokuItemData(0xFF0523, ItemClassification.progression),
    itemnames.patchouli_5sc_rf: SokuItemData(0xFF0524, ItemClassification.progression),
    itemnames.patchouli_5sc_ps: SokuItemData(0xFF0525, ItemClassification.progression),
    itemnames.patchouli_5sc_rdr: SokuItemData(0xFF0526, ItemClassification.progression),
...
youmu_skill_table = {
    ...
    itemnames.youmu_22a1:   SokuItemData(0xFF0610, ItemClassification.progression),
    itemnames.youmu_22a2:   SokuItemData(0xFF0611, ItemClassification.progression),

}

youmu_spell_table = {
    itemnames.youmu_2sc_sop:    SokuItemData(0xFF0612, ItemClassification.progression),
    itemnames.youmu_2sc_gwop:   SokuItemData(0xFF0613, ItemClassification.progression),
    itemnames.youmu_3sc_m:      SokuItemData(0xFF0614, ItemClassification.progression),
    itemnames.youmu_3sc_tcb:    SokuItemData(0xFF0615, ItemClassification.progression),
    itemnames.youmu_3sc_soc:    SokuItemData(0xFF0616, ItemClassification.progression),
    itemnames.youmu_4sc_rfd:    SokuItemData(0xFF0617, ItemClassification.progression),
    itemnames.youmu_4sc_atn:    SokuItemData(0xFF0618, ItemClassification.progression),
    itemnames.youmu_5sc_soe:    SokuItemData(0xFF0619, ItemClassification.progression),
    itemnames.youmu_5sc_solad:  SokuItemData(0xFF0620, ItemClassification.progression),
    itemnames.youmu_5sc_src:    SokuItemData(0xFF0621, ItemClassification.progression),
...
remilia_skill_table = {
    ...
    itemnames.remilia_22a1:    SokuItemData(0xFF0710, ItemClassification.progression),
    itemnames.remilia_22a2:    SokuItemData(0xFF0711, ItemClassification.progression),

}

remilia_spell_table = {
    itemnames.remilia_2sc_hb:    SokuItemData(0xFF0712, ItemClassification.progression),
    itemnames.remilia_2sc_dkc:   SokuItemData(0xFF0713, ItemClassification.progression),
    itemnames.remilia_3sc_rtnc:  SokuItemData(0xFF0714, ItemClassification.progression),
    itemnames.remilia_3sc_bls:   SokuItemData(0xFF0715, ItemClassification.progression),
    itemnames.remilia_3sc_mf:    SokuItemData(0xFF0716, ItemClassification.progression),
    itemnames.remilia_4sc_stg:   SokuItemData(0xFF0717, ItemClassification.progression),
    itemnames.remilia_4sc_mv:    SokuItemData(0xFF0718, ItemClassification.progression),
    itemnames.remilia_4sc_rs:    SokuItemData(0xFF0719, ItemClassification.progression),
    itemnames.remilia_5sc_sd:    SokuItemData(0xFF0720, ItemClassification.progression),
    itemnames.remilia_5sc_dc:    SokuItemData(0xFF0721, ItemClassification.progression),
...
yuyuko_skill_table = {
    ...
    itemnames.yuyuko_421a1:   SokuItemData(0xFF0810, ItemClassification.progression),
    itemnames.yuyuko_421a2:   SokuItemData(0xFF0811, ItemClassification.progression),

}

yuyuko_spell_table = {
    itemnames.yuyuko_1sc_pttu:   SokuItemData(0xFF0812, ItemClassification.progression),
    itemnames.yuyuko_2sc_gd:     SokuItemData(0xFF0813, ItemClassification.progression),
    itemnames.yuyuko_2sc_ad:     SokuItemData(0xFF0814, ItemClassification.progression),
    itemnames.yuyuko_2sc_atbf:   SokuItemData(0xFF0815, ItemClassification.progression),
    itemnames.yuyuko_3sc_itta:   SokuItemData(0xFF0816, ItemClassification.progression),
    itemnames.yuyuko_3sc_rb:     SokuItemData(0xFF0817, ItemClassification.progression),
    itemnames.yuyuko_4sc_en:     SokuItemData(0xFF0818, ItemClassification.progression),
    itemnames.yuyuko_4sc_tttn:   SokuItemData(0xFF0819, ItemClassification.progression),
    itemnames.yuyuko_4sc_dl:     SokuItemData(0xFF0820, ItemClassification.progression),
    itemnames.yuyuko_5sc_gh:     SokuItemData(0xFF0821, ItemClassification.progression),
    itemnames.yuyuko_5sc_socb:   SokuItemData(0xFF0822, ItemClassification.progression),
...
yukari_skill_table = {
    ...
    itemnames.yukari_421a1:   SokuItemData(0xFF0910, ItemClassification.progression),
    itemnames.yukari_421a2:   SokuItemData(0xFF0911, ItemClassification.progression),

}

yukari_spell_table = {
    itemnames.yukari_1sc_bbtat:   SokuItemData(0xFF0912, ItemClassification.progression),
    itemnames.yukari_1sc_c:       SokuItemData(0xFF0913, ItemClassification.progression),
    itemnames.yukari_2sc_lwv:     SokuItemData(0xFF0914, ItemClassification.progression),
    itemnames.yukari_3sc_qb:      SokuItemData(0xFF0915, ItemClassification.progression),
    itemnames.yukari_3sc_ry:      SokuItemData(0xFF0916, ItemClassification.progression),
    itemnames.yukari_3sc_ob:      SokuItemData(0xFF0917, ItemClassification.progression),
    itemnames.yukari_3sc_nof:     SokuItemData(0xFF0918, ItemClassification.progression),
    itemnames.yukari_4sc_cqb:     SokuItemData(0xFF0919, ItemClassification.progression),
    itemnames.yukari_4sc_tmeol:   SokuItemData(0xFF0920, ItemClassification.progression),
    itemnames.yukari_5sc_tttos:   SokuItemData(0xFF0921, ItemClassification.progression),
}
...
suika_skill_table = {
    ...
    itemnames.suika_22a1:    SokuItemData(0xFF0A10, ItemClassification.progression),
    itemnames.suika_22a2:    SokuItemData(0xFF0A11, ItemClassification.progression),

}

suika_spell_table = {
    itemnames.suika_1sc_gad:     SokuItemData(0xFF0A12, ItemClassification.progression),
    itemnames.suika_2sc_tmt:     SokuItemData(0xFF0A13, ItemClassification.progression),
    itemnames.suika_2sc_aoob:    SokuItemData(0xFF0A14, ItemClassification.progression),
    itemnames.suika_2sc_mp:      SokuItemData(0xFF0A15, ItemClassification.progression),
    itemnames.suika_3sc_tsd:     SokuItemData(0xFF0A16, ItemClassification.progression),
    itemnames.suika_4sc_aogb:    SokuItemData(0xFF0A17, ItemClassification.progression),
    itemnames.suika_4sc_mpp:     SokuItemData(0xFF0A18, ItemClassification.progression),
    itemnames.suika_4sc_sc:      SokuItemData(0xFF0A19, ItemClassification.progression),
    itemnames.suika_5sc_ta:      SokuItemData(0xFF0A20, ItemClassification.progression),
    itemnames.suika_5sc_momo:    SokuItemData(0xFF0A21, ItemClassification.progression),
...
reisen_skill_table = {
    ...
    itemnames.reisen_22a1:    SokuItemData(0xFF0B10, ItemClassification.progression),
    itemnames.reisen_22a2:    SokuItemData(0xFF0B11, ItemClassification.progression),

}

reisen_spell_table = {
    itemnames.reisen_1sc_cv:     SokuItemData(0xFF0B12, ItemClassification.progression),
    itemnames.reisen_1sc_d:      SokuItemData(0xFF0B13, ItemClassification.progression),
    itemnames.reisen_2sc_gwo:    SokuItemData(0xFF0B14, ItemClassification.progression),
    itemnames.reisen_2sc_im:     SokuItemData(0xFF0B15, ItemClassification.progression),
    itemnames.reisen_3sc_ms:     SokuItemData(0xFF0B16, ItemClassification.progression),
    itemnames.reisen_3sc_cw:     SokuItemData(0xFF0B17, ItemClassification.progression),
    itemnames.reisen_3sc_d:      SokuItemData(0xFF0B18, ItemClassification.progression),
    itemnames.reisen_3sc_gpe:    SokuItemData(0xFF0B19, ItemClassification.progression),
    itemnames.reisen_3sc_xw:     SokuItemData(0xFF0B20, ItemClassification.progression),
    itemnames.reisen_4sc_lb:     SokuItemData(0xFF0B21, ItemClassification.progression),
    itemnames.reisen_5sc_lre:    SokuItemData(0xFF0B22, ItemClassification.progression),
...
aya_skill_table = {
    ...
    itemnames.aya_22a1:    SokuItemData(0xFF0C10, ItemClassification.progression),
    itemnames.aya_22a2:    SokuItemData(0xFF0C11, ItemClassification.progression),

}

aya_spell_table = {
    itemnames.aya_1sc_swv:      SokuItemData(0xFF0C12, ItemClassification.progression),
    itemnames.aya_2sc_wottp:    SokuItemData(0xFF0C13, ItemClassification.progression),
    itemnames.aya_2sc_tls:      SokuItemData(0xFF0C14, ItemClassification.progression),
    itemnames.aya_3sc_mlf:      SokuItemData(0xFF0C15, ItemClassification.progression),
    itemnames.aya_3sc_tm:       SokuItemData(0xFF0C16, ItemClassification.progression),
    itemnames.aya_3sc_sg:       SokuItemData(0xFF0C17, ItemClassification.progression),
    itemnames.aya_4sc_rftm:     SokuItemData(0xFF0C18, ItemClassification.progression),
    itemnames.aya_4sc_dd:       SokuItemData(0xFF0C19, ItemClassification.progression),
    itemnames.aya_5sc_ittd:     SokuItemData(0xFF0C20, ItemClassification.progression),
    itemnames.aya_5sc_id:       SokuItemData(0xFF0C21, ItemClassification.progression),
...
komachi_skill_table = {
    ...
    itemnames.komachi_22a1:    SokuItemData(0xFF0D10, ItemClassification.progression),
    itemnames.komachi_22a2:    SokuItemData(0xFF0D11, ItemClassification.progression),

}

komachi_spell_table = {
    itemnames.komachi_1sc_fotr:     SokuItemData(0xFF0D12, ItemClassification.progression),
    itemnames.komachi_1sc_afs:      SokuItemData(0xFF0D13, ItemClassification.progression),
    itemnames.komachi_3sc_fitdf:    SokuItemData(0xFF0D14, ItemClassification.progression),
    itemnames.komachi_3sc_ibs:      SokuItemData(0xFF0D15, ItemClassification.progression),
    itemnames.komachi_3sc_hcoa:     SokuItemData(0xFF0D16, ItemClassification.progression),
    itemnames.komachi_4sc_sofj:     SokuItemData(0xFF0D17, ItemClassification.progression),
    itemnames.komachi_4sc_sows:     SokuItemData(0xFF0D18, ItemClassification.progression),
    itemnames.komachi_5sc_sle:      SokuItemData(0xFF0D19, ItemClassification.progression),
    itemnames.komachi_5sc_upl:      SokuItemData(0xFF0D20, ItemClassification.progression),
...
iku_skill_table = {
    ...
    itemnames.iku_22a1:    SokuItemData(0xFF0E10, ItemClassification.progression),
    itemnames.iku_22a2:    SokuItemData(0xFF0E11, ItemClassification.progression),

}

iku_spell_table = {
    itemnames.iku_1sc_tds:       SokuItemData(0xFF0E12, ItemClassification.progression),
    itemnames.iku_1sc_vlt:       SokuItemData(0xFF0E13, ItemClassification.progression),
    itemnames.iku_2sc_sts:       SokuItemData(0xFF0E14, ItemClassification.progression),
    itemnames.iku_3sc_dd:        SokuItemData(0xFF0E15, ItemClassification.progression),
    itemnames.iku_3sc_edp:       SokuItemData(0xFF0E16, ItemClassification.progression),
    itemnames.iku_3sc_lds:       SokuItemData(0xFF0E17, ItemClassification.progression),
    itemnames.iku_3sc_ts:        SokuItemData(0xFF0E18, ItemClassification.progression),
    itemnames.iku_4sc_vls:       SokuItemData(0xFF0E19, ItemClassification.progression),
    itemnames.iku_4sc_ootfcd:    SokuItemData(0xFF0E20, ItemClassification.progression),
    itemnames.iku_5sc_sos:       SokuItemData(0xFF0E21, ItemClassification.progression),
...
tenshi_card_table = {
    ...
    itemnames.tenshi_22a1:    SokuItemData(0xFF0F10, ItemClassification.progression),
    itemnames.tenshi_22a2:    SokuItemData(0xFF0F11, ItemClassification.progression),

}

tenshi_spell_table = {
    itemnames.tenshi_2sc_sous:     SokuItemData(0xFF0F12, ItemClassification.progression),
    itemnames.tenshi_2sc_sor:      SokuItemData(0xFF0F13, ItemClassification.progression),
    itemnames.tenshi_3sc_sodj:     SokuItemData(0xFF0F14, ItemClassification.progression),
    itemnames.tenshi_3sc_sos:      SokuItemData(0xFF0F15, ItemClassification.progression),
    itemnames.tenshi_3sc_swp:      SokuItemData(0xFF0F16, ItemClassification.progression),
    itemnames.tenshi_4sc_mr:       SokuItemData(0xFF0F17, ItemClassification.progression),
    itemnames.tenshi_4sc_soe:      SokuItemData(0xFF0F18, ItemClassification.progression),
    itemnames.tenshi_5sc_sowaj:    SokuItemData(0xFF0F19, ItemClassification.progression),
    itemnames.tenshi_5sc_wcp:      SokuItemData(0xFF0F20, ItemClassification.progression),
    itemnames.tenshi_5sc_swr:      SokuItemData(0xFF0F21, ItemClassification.progression),
...
sanae_skill_table = {
    ...
    itemnames.sanae_22a1:    SokuItemData(0xFF1010, ItemClassification.progression),
    itemnames.sanae_22a2:    SokuItemData(0xFF1011, ItemClassification.progression),

}

sanae_spell_table = {
    itemnames.sanae_2sc_cogc:     SokuItemData(0xFF1012, ItemClassification.progression),
    itemnames.sanae_2sc_gt:       SokuItemData(0xFF1013, ItemClassification.progression),
    itemnames.sanae_2sc_rob:      SokuItemData(0xFF1014, ItemClassification.progression),
    itemnames.sanae_3sc_tdtss:    SokuItemData(0xFF1015, ItemClassification.progression),
    itemnames.sanae_3sc_mds:      SokuItemData(0xFF1016, ItemClassification.progression),
    itemnames.sanae_4sc_fr:       SokuItemData(0xFF1017, ItemClassification.progression),
    itemnames.sanae_4sc_notss:    SokuItemData(0xFF1018, ItemClassification.progression),
    itemnames.sanae_5sc_mm:       SokuItemData(0xFF1019, ItemClassification.progression),
    itemnames.sanae_5sc_ncp:      SokuItemData(0xFF1020, ItemClassification.progression),
...
cirno_skill_table = {
    ...
    itemnames.cirno_22a1:    SokuItemData(0xFF1110, ItemClassification.progression),
    itemnames.cirno_22a2:    SokuItemData(0xFF1111, ItemClassification.progression),

}

cirno_spell_table = {
    itemnames.cirno_2sc_img:    SokuItemData(0xFF1112, ItemClassification.progression),
    itemnames.cirno_2sc_fs:     SokuItemData(0xFF1113, ItemClassification.progression),
    itemnames.cirno_3sc_cs:     SokuItemData(0xFF1114, ItemClassification.progression),
    itemnames.cirno_3sc_sik:    SokuItemData(0xFF1115, ItemClassification.progression),
    itemnames.cirno_3sc_sf:     SokuItemData(0xFF1116, ItemClassification.progression),
    itemnames.cirno_3sc_fa:     SokuItemData(0xFF1117, ItemClassification.progression),
    itemnames.cirno_3sc_ifb:    SokuItemData(0xFF1118, ItemClassification.progression),
    itemnames.cirno_4sc_fc:     SokuItemData(0xFF1119, ItemClassification.progression),
    itemnames.cirno_4sc_it:     SokuItemData(0xFF1120, ItemClassification.progression),
    itemnames.cirno_5sc_pf:     SokuItemData(0xFF1121, ItemClassification.progression),
    itemnames.cirno_5sc_gc:     SokuItemData(0xFF1122, ItemClassification.progression),
...
meiling_skill_table = {
    ...
    itemnames.meiling_22a1:    SokuItemData(0xFF1210, ItemClassification.progression),
    itemnames.meiling_22a2:    SokuItemData(0xFF1211, ItemClassification.progression),

}

meiling_spell_table = {
    itemnames.meiling_2sc_cw:       SokuItemData(0xFF1212, ItemClassification.progression),
    itemnames.meiling_2sc_irf:      SokuItemData(0xFF1213, ItemClassification.progression),
    itemnames.meiling_3sc_sb:       SokuItemData(0xFF1214, ItemClassification.progression),
    itemnames.meiling_3sc_rf:       SokuItemData(0xFF1215, ItemClassification.progression),
    itemnames.meiling_3sc_edsdk:    SokuItemData(0xFF1216, ItemClassification.progression),
    itemnames.meiling_4sc_mcd:      SokuItemData(0xFF1217, ItemClassification.progression),
    itemnames.meiling_4sc_rt:       SokuItemData(0xFF1218, ItemClassification.progression),
    itemnames.meiling_4sc_fter:     SokuItemData(0xFF1219, ItemClassification.progression),
    itemnames.meiling_5sc_emsb:     SokuItemData(0xFF1220, ItemClassification.progression),
    itemnames.meiling_5sc_rkf:      SokuItemData(0xFF1221, ItemClassification.progression),
    itemnames.meiling_5sc_rbr:      SokuItemData(0xFF1222, ItemClassification.progression),
...
okuu_card_table = { #Utsuho, also affectionately reffered to as "Okuu"
    ...
    itemnames.okuu_22a1:    SokuItemData(0xFF1310, ItemClassification.progression),
    itemnames.okuu_22a2:    SokuItemData(0xFF1311, ItemClassification.progression),

}

okuu_spell_table = {
    itemnames.okuu_1sc_has:    SokuItemData(0xFF1312, ItemClassification.progression),
    itemnames.okuu_2sc_st:     SokuItemData(0xFF1313, ItemClassification.progression),
    itemnames.okuu_2sc_nv:     SokuItemData(0xFF1314, ItemClassification.progression),
    itemnames.okuu_3sc_mf:     SokuItemData(0xFF1315, ItemClassification.progression),
    itemnames.okuu_3sc_fs:     SokuItemData(0xFF1316, ItemClassification.progression),
    itemnames.okuu_3sc_cs:     SokuItemData(0xFF1317, ItemClassification.progression),
    itemnames.okuu_3sc_htb:    SokuItemData(0xFF1318, ItemClassification.progression),
    itemnames.okuu_4sc_tts:    SokuItemData(0xFF1319, ItemClassification.progression),
    itemnames.okuu_4sc_nbg:    SokuItemData(0xFF1320, ItemClassification.progression),
    itemnames.okuu_4sc_yd:     SokuItemData(0xFF1321, ItemClassification.progression),
    itemnames.okuu_4sc_ud:     SokuItemData(0xFF1322, ItemClassification.progression),
    itemnames.okuu_4sc_ss:     SokuItemData(0xFF1323, ItemClassification.progression),
    itemnames.okuu_5sc_gf:     SokuItemData(0xFF1324, ItemClassification.progression),
    itemnames.okuu_5sc_an:     SokuItemData(0xFF1325, ItemClassification.progression),
...
suwako_skill_table = {
    ...
    itemnames.suwako_22a1:    SokuItemData(0xFF1410, ItemClassification.progression),
    itemnames.suwako_22a2:    SokuItemData(0xFF1411, ItemClassification.progression),

}

suwako_spell_table = {
    itemnames.suwako_2sc_mcw:      SokuItemData(0xFF1412, ItemClassification.progression),
    itemnames.suwako_2sc_mmr:      SokuItemData(0xFF1413, ItemClassification.progression),
    itemnames.suwako_3sc_mg:       SokuItemData(0xFF1414, ItemClassification.progression),
    itemnames.suwako_3sc_bcb:      SokuItemData(0xFF1415, ItemClassification.progression),
    itemnames.suwako_3sc_fbte:     SokuItemData(0xFF1416, ItemClassification.progression),
    itemnames.suwako_4sc_hrj:      SokuItemData(0xFF1417, ItemClassification.progression),
    itemnames.suwako_4sc_shaef:    SokuItemData(0xFF1418, ItemClassification.progression),
    itemnames.suwako_4sc_ml:       SokuItemData(0xFF1419, ItemClassification.progression),
    itemnames.suwako_4sc_rfoh:     SokuItemData(0xFF1420, ItemClassification.progression),
    itemnames.suwako_4sc_cah:      SokuItemData(0xFF1421, ItemClassification.progression),
    itemnames.suwako_5sc_ms:       SokuItemData(0xFF1422, ItemClassification.progression),
...
filler_table = {
    ...
    itemnames.f_poke_more_opp:        SokuItemData(0xFF2010, ItemClassification.filler),
    itemnames.f_drain_opp:            SokuItemData(0xFF2011, ItemClassification.filler),
    itemnames.f_spirit_regen:         SokuItemData(0xFF2012, ItemClassification.filler),
    itemnames.f_heal_spirit:          SokuItemData(0xFF2013, ItemClassification.filler),
